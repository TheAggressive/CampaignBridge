...
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| Template authoring | `core-data`-backed standalone editor, autosave, shared undo history, template metadata, constrained CampaignBridge email-block library, compiled iframe preview | Draft/publish/revision/duplication workflow, test delivery, and broader browser E2E coverage                                                        |
...
| Providers          | Provider interface, verified Mailchimp connection status, Mailchimp template-section discovery, HTML export adapter, encrypted credentials | No complete audience, provider-draft, test-send, schedule/send, reconciliation, or reporting lifecycle                                             |
...
| Admin              | File-based screens, secure form system, settings, post-type selection, status page                                                         | Demo/test screens remain and provider settings are not yet one canonical connection model                                                           |
