...
| Admin              | File-based screens, secure form system, settings, post-type selection, status page, provider connection settings with capability-gated save | Provider verification workflow, audience management UI, and connection health display in the settings screen                                                    |
