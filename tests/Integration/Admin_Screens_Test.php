...
class Admin_Screens_Test extends Test_Case {
	...
	public function test_post_types_screen_handles_form_submission(): void {
		...
		// $saved_data = get_option( 'campaignbridge_post_types' );
	...
	/**
	 * Render forms demo screen.
	 */
	private function render_forms_demo_screen(): void {
		global $screen;
		require \CampaignBridge_Plugin::path() . 'includes/Admin/Screens/forms-demo.php';
	}
