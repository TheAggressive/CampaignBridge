...
registerBlockType('campaignbridge/email-post-excerpt', {
                ...
                {moreStyle === 'link' ? (
                  <>
                    ...
                    <ToggleControl
                      ...
                      onChange={(v) => setAttributes({ linkUnderline: !!v })}
                    />
                  </>
                ) : (
                  <>
                    ...
                    <RangeControl
                      ...
                      max={24}
                      onChange={(v) =>
                        setAttributes({ buttonRadius: Number(v) || 0 })
                      }
                    />
                    <RangeControl
                      __nextHasNoMarginBottom
                      ...
                      step={2}
                      onChange={(v) =>
                        setAttributes({ buttonPaddingX: Number(v) || 0 })
                      }
                    />
                    <RangeControl
                      __nextHasNoMarginBottom
                      ...
                      step={2}
                      onChange={(v) =>
                        setAttributes({ buttonPaddingY: Number(v) || 0 })
                      }
                    />
                  </>
                )}
