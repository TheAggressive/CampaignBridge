...
export default function Edit( {
	...
	const blockProps = useBlockProps( {
		className:
			morePlacement === 'inline' ? 'has-inline-readmore' : undefined,
	} );
			...
			<InspectorControls>
				...
				>
					<RangeControl
						...
						onChange={ ( v ) =>
							setAttributes( { maxWords: Number( v ) || 0 } )
						}
						min={ 10 }
						max={ 150 }
						step={ 1 }
				...
				>
					<ToggleControl
						...
						onChange={ ( v ) =>
							setAttributes( { enableSeparator: !! v } )
						}
						help={ __(
						...
						<>
							...
							{ separatorType === 'custom' && (
								<TextControl
									...
									onChange={ ( v ) =>
										setAttributes( { customSeparator: v } )
									}
									placeholder={ __(
										'e.g., |, —, •, etc.',
										'campaignbridge'
