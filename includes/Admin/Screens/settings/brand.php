	...
	$screen->localize_script(
		...
		array(
			...
			'i18n'    => array(
				...
				'fontSaved'        => __( 'Font saved.', 'campaignbridge' ),
				...
				'fontLookup'       => __( 'Find another Google Font', 'campaignbridge' ),
				'fontLookupHelp'   => __( 'Search the official Google Fonts catalogue. Added fonts are snapshotted for deterministic email output and retain email-safe fallbacks.', 'campaignbridge' ),
