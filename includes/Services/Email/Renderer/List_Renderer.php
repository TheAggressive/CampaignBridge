...
/** Renders a constrained unordered or ordered email list. */
final class List_Renderer extends Abstract_Renderer {
	/** {@inheritDoc} */
	public function block_name(): string {
		return 'campaignbridge/list';
	}
	...
	public function allowed_children(): array {
		return array( 'campaignbridge/list-item' );
	}
	...
	public function normalize( Block_Node $block ): Block_Node {
		return $block->with_attributes(
			array(
				'ordered' => Renderer_Support::boolean_attribute( $block->attributes(), 'ordered', false ),
			)
		);
	}
