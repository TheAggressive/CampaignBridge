...
final class Native_Style_Support {
	...
	private const SUPPORTED = array(
		...
		'campaignbridge/post-title'        => array( 'color.text', 'typography.fontSize', 'typography.fontFamily', 'typography.lineHeight' ),
		'campaignbridge/post-excerpt'      => array( 'color.text', 'typography.fontSize', 'typography.fontFamily', 'typography.lineHeight' ),
		...
		'campaignbridge/heading'           => array( 'color.text', 'typography.fontSize', 'typography.fontFamily', 'typography.lineHeight' ),
