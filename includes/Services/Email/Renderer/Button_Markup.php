...
final class Button_Markup {
	 ...
	 */
	public static function html( string $url, string $label, string $background, string $text, ?string $align, int $width = 200, string $variant = 'primary', string $font_family = 'Arial,sans-serif' ): string {
		...
		$link_style = 'display:inline-block;padding:12px 24px;font-family:' . $font_family . ';font-size:16px;font-weight:bold;line-height:20px;color:'
		...
		switch ( $variant ) {
			case 'outline':
				...
				$link_style = 'display:inline-block;padding:10px 20px;font-family:' . $font_family . ';font-size:16px;font-weight:bold;line-height:20px;color:'
		...
		$button = '<!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="'
			...
			. '><w:anchorlock/><center style="color:' . $vml_text . ';font-family:' . $font_family . ';font-size:16px;font-weight:bold">'
