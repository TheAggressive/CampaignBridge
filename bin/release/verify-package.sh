...
for required in campaignbridge.php uninstall.php includes/Autoloader.php includes/Plugin.php dist/styles/styles.css assets/brand/CB_Horizontal_Color_Light.svg; do
