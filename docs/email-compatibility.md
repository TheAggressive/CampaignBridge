...
| Scenario               | Covers                                                                                                   |
| ---------------------- | -------------------------------------------------------------------------------------------------------- |
| `universal-newsletter` | Document shell, preheader, section, bound brand logo, navigation, social links, image, linked video poster, rich text and links, list, button, divider, spacer, compliance footer |
